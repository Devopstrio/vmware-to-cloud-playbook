...
flowchart TD
    ...
    Pairing["Site Pairing"] --> Mesh["Interconnect Mesh"]
    Mesh["Interconnect Mesh"] --> L2["L2 Extension"]
    L2["L2 Extension"] --> Sync["Bulk Migration / vMotion"]
```
...
flowchart TD
    ...
    Factory["Global Migration Factory"] --> AMER["AMER Migration Node"]
    EMEA["EMEA Migration Node"] --> vCenter1["London vCenter"]
    AMER["AMER Migration Node"] --> vCenter2["New York vCenter"]
```
...
flowchart LR
    ...
    Wave2["Wave 2: Production A"] --> Wave3["Wave 3: Production B"]
    Wave3["Wave 3: Production B"] --> Wave4["Wave 4: Cleanup/Retire"]
```
...
flowchart LR
    ...
    Auth{"Auth Check"} --> Valid{"6R Strategy Valid?"}
    Valid{"6R Strategy Valid?"} --> Approve["Execute Migration"]
```
...
flowchart TD
    ...
    Compare["ROI Engine"] --> Report["Business Case Report"]
```
...
flowchart LR
    ...
    AVS["Azure VMware Solution"] <--> GCVE["Google Cloud VMware Engine"]
```
...
flowchart LR
    ...
    Hub["Security Hub"] -->|TLS 1.3| Cloud["Target Landing Zone"]
```
...
flowchart TD
    ...
    FW["L7 Firewall Inspection"] --> Segment["Isolated Spoke VNet"]
```
...
flowchart TD
    ...
    Q["Quality/Stability"] --> Score["Migration Maturity"]
    S["Strategy Alignment"] --> Score["Migration Maturity"]
```
...
flowchart LR
    ...
    Owner["Business Owner"] -->|Strategy: Approve| Hub["Migration Hub"]
```
...
flowchart TD
    ...
    Entra["Microsoft Entra ID"] -->|SSO| Portal["Migration Command Center"]
```
...
flowchart LR
    ...
    TF["Terraform"] --> Net["Deploy Secure Networking"]
    TF["Terraform"] --> HCX["Install HCX Components"]
```
...
flowchart TD
    ...
    AI["Predictive Analytics"] --> Action["Adjust Bandwidth Throttling"]
```
...
flowchart LR
    ...
    Run["Execute Cutover"] --> Post["Post-Cutover Validation"]
    Post["Post-Cutover Validation"] -->|Fail| Rollback["Automated Rollback"]
```
...
flowchart LR
    ...
    Lake["Migration Metadata Lake"] --> Audit["Compliance Report"]
```
...
flowchart TD
    ...
    History["Version History"] --> Evidence["Audit Evidence Pack"]
```
